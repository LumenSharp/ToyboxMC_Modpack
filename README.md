...
[[Modpage]](https://modrinth.com/mod/companion)
...
<details>
  <summary>[Click Me For List Of Eyes]</summary>

    - "Old Eye" : Found in Desert Pyramids
    - "Nether Eye" : Found in Nether Fortresses
    - "Cold Eye" : Found in Igloos
    - "Rogue Eye" : Found in Jungle Pyramids
    - "Black Eye" : Found in Buried Chests
    - "Magical Eye" : Dropped by killed Evokers
    - "Lost Eye" : Found in Mineshafts
    - "Corrupted Eye" : Found in Pillager Outpost chests
    - "Wither Eye" : Dropped by killed Withers
    - "Guardian Eye" : Dropped by killed Elder Guardians
    - "Witch Eye" : Crafted using witch pupil
    - "Cursed Eye" : Found in Bastion treasure chests
    - "Exotic Eye" : Crafted using aquatic items
    - "Evil Eye" : Bought from a 'master'-level cleric villager
    - "Undead Eye" : Crafted using Undead Soul
    - "Cryptic Eye" : Every time a player uses an enchantment table, it has a small chance of dropping
</details>
...
Completely replaces the vanilla Endermen with highly customized replacements. Endermen types now depend on which biome they spawn in.
...
Adds the 'outvoted' mobs from the minecraft mob votes. Also expands on their init concepts.
...
Adds many block variations to the vanilla stone types.
